# Support code for w9 assignment, MLPR 2020.

# One way to use these functions in your code is:
# from w9_support.py import *
...
def nn_cost(params, X, yy=None, alpha=None):
    """NN_COST simple neural network cost function and gradients, or predictions
     ...
     Inputs:
             params (ww, bb, V, bk), where:
              ...
              alpha     scalar L2 regularization for weights

     Outputs:
                     E  regularized sum of squares error
    ...
    # Forwards pass: computation of cost
    ...
    # Reverse pass: computation of gradients
    F_bar = 2*res # N,
